package com.donghyun.basic.filter;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
	...
	// # 2. 인증 토큰을 발급 받은 후 매 요청 마다 인증 토큰을 request header의 Authorization 필드의 값으로 Bearer 토큰을 포함하여 요청
	...
	private String parseBearerToken(HttpServletRequest request) {
			...
			// * 2. 'Authorization' 필드 값에서 'Bearer' 이후의 값을 겨자옴
			// Bearer qweqdwqsdqwfqsf
