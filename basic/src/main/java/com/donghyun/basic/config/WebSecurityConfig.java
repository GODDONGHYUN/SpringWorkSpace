package com.donghyun.basic.config;
...
import com.donghyun.basic.filter.JwtAuthenticationFilter;
import com.donghyun.basic.provider.OAuth2SuccessHandler;
import com.donghyun.basic.service.implement.OAuth2UserServiceImplement;
    ...
    protected SecurityFilterChain configure(HttpSecurity security) throws Exception {
        ...
        .authorizeHttpRequests(request -> request
            ...
            .anyRequest().authenticated()
				...
				.oauth2Login(oauth2 -> oauth2.redirectionEndpoint(endpoint ->
